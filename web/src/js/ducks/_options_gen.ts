...
export interface OptionsState {
    ...
    protobuf_file: string;
    protobuf_interceptor_enabled: boolean;
    advanced_intercept_enabled: boolean;
    advanced_intercept_inbound: boolean;
    advanced_intercept_outbound: boolean;
    advanced_intercept_urls: string;
    advanced_block_urls: string;
    advanced_intercept_mode: string;
    proxy_debug: boolean;
...
export const defaultState: OptionsState = {
    ...
    protobuf_file: "protobuf.txt",
    protobuf_interceptor_enabled: false,
    advanced_intercept_enabled: false,
    advanced_intercept_inbound: true,
    advanced_intercept_outbound: true,
    advanced_intercept_urls: "",
    advanced_block_urls: "",
    advanced_intercept_mode: "pause",
    proxy_debug: false,
    proxyauth: undefined,
    rawtcp: true,
