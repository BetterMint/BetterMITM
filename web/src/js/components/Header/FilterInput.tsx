...
export default class FilterInput extends Component<
    ...
    FilterInputState
> {
    declare props: React.ComponentProps<typeof FilterInput>;
    declare state: FilterInputState;
    declare setState: React.Component<FilterInputProps, FilterInputState>['setState'];

    inputRef = React.createRef<HTMLInputElement>();

    constructor(props: FilterInputProps, context?: any) {
        super(props, context);
