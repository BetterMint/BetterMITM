...
import AdvancedInterceptor from "./Modes/AdvancedInterceptor";
import RateLimiter from "./Modes/RateLimiter";
...
export default function Modes() {
    ...
    return (
        <div className="modes">
            ...
            <p>Configure how you want to intercept traffic with BetterMITM.</p>
