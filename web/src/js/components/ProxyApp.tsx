...
class ProxyAppMain extends Component<ProxyAppMainProps, ProxyAppMainState> {
    declare props: React.ComponentProps<typeof ProxyAppMain>;
    declare setState: React.Component<ProxyAppMainProps, ProxyAppMainState>['setState'];
            ...
            return (
                <div className="container">
                    ...
                    <p>
                        ...
                        <a href="https://github.com/BetterMITM/BetterMITM/issues">
                            https:
                        </a>
                        .
                    </p>
