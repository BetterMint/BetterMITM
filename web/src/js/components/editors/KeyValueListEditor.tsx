...
class Row extends Component<RowProps> {
    declare props: React.ComponentProps<typeof Row>;
...
export default class KeyValueListEditor extends Component<
    ...
    KeyValueListState
> {
    declare props: React.ComponentProps<typeof KeyValueListEditor>;
    state: KeyValueListState;
    setState: React.Component<KeyValueListProps, KeyValueListState>['setState'];
