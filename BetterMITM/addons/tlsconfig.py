...
from BetterMITM import tls
from BetterMITM.net import tls as net_tls
from BetterMITM.options import CONF_BASENAME
from BetterMITM.proxy import context
from BetterMITM.proxy.layers import modes
from BetterMITM.proxy.layers import quic
from BetterMITM.proxy.layers import tls as proxy_tls
...
DEFAULT_HOSTFLAGS = (
    ...
    | getattr(SSL._lib, "X509_CHECK_FLAG_NEVER_CHECK_SUBJECT", 0)
)
        ...
        if (
            ...
            if self.certstore.default_ca.has_expired():
                logger.warning(
                    ...
                    "The CA will be regenerated automatically after restarting BetterMITM.\n"
                    "See https://docs.BetterMITM.org/stable/concepts-certificates/ for additional help.",
                )
