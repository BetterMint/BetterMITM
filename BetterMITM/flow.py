...
class Error(serializable.SerializableDataclass):
    ...
    which is represented by a normal `BetterMITM.http.Response` object. This class is
...
class Flow(serializable.Serializable):
    ...
    See also:
     - BetterMITM.http.HTTPFlow
     - BetterMITM.tcp.TCPFlow
     - BetterMITM.udp.UDPFlow
    """

    client_conn: connection.Client
    """The client that connected to BetterMITM."""
    ...
    intercepted: bool
    """
    If `True`, the flow is currently paused by BetterMITM.
    ...
    def timestamp_start(self) -> float:
        ...
        *Read-only:* Start time of the flow.
        ...
        `BetterMITM.connection.Client.timestamp_start` or `BetterMITM.http.Request.timestamp_start`.
        """
