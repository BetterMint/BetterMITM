...
from BetterMITM import options as moptions
from BetterMITM import tls
from BetterMITM.connection import Address
from BetterMITM.connection import Client
...
from BetterMITM.utils.data import pkg_data
    ...
    async def handle(reader, writer):
        ...
        def tls_start_client(tls_start: tls.TlsData):
            ...
            ssl_context.use_certificate_chain_file(
                pkg_data.path(
                    "../test/BetterMITM/data/verificationcerts/trusted-leaf.crt"
                )
            )
