...
from BetterMITM.net import tls
...
from BetterMITM.proxy.layers.tls import TlsClienthelloHook
from BetterMITM.proxy.layers.tls import TlsEstablishedClientHook
from BetterMITM.proxy.layers.tls import TlsEstablishedServerHook
from BetterMITM.proxy.layers.tls import TlsFailedClientHook
from BetterMITM.proxy.layers.tls import TlsFailedServerHook
from BetterMITM.proxy.layers.udp import UDPLayer
from BetterMITM.tls import ClientHelloData
...
def tls_settings_to_configuration(
    ...
    return QuicConfiguration(
        ...
        is_client=is_client,
        secrets_log_file=(
            QuicSecretsLogger(tls.log_master_secret)
