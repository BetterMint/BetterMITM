...
def dummy_crl(
    ...
    builder = builder.add_extension(x509.CRLNumber(1000), False)
...
class CertStore:
    ...
    def load_dhparam(path: Path) -> DHParams:
        ...
        if bio != OpenSSL.SSL._ffi.NULL:
            ...
            return dh
        raise RuntimeError("Error loading DH Params.")
    ...
    def add_cert_file(
        ...
        if cert.is_ca:
            logger.warning(
                ...
                f"This indicates a misconfiguration, see https://docs.BetterMITM.org/stable/concepts-certificates/."
            )
