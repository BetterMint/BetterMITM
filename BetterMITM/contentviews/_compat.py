...
from BetterMITM.contentviews import SyntaxHighlight
...
if typing.TYPE_CHECKING:
    from BetterMITM.contentviews.base import TViewLine
    from BetterMITM.contentviews.base import View
...
@deprecated("Use `BetterMITM.contentviews.registry` instead.")
...
@deprecated("Use `BetterMITM.contentviews.Contentview` instead.")
