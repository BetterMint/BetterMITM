...
from BetterMITM.tools.console import commandexecutor
from BetterMITM.tools.console import common
from BetterMITM.tools.console import flowlist
from BetterMITM.tools.console import quickhelp
from BetterMITM.tools.console import signals
from BetterMITM.tools.console.commander import commander
...
class ActionBar(urwid.WidgetWrap):
    def __init__(self, master: BetterMITM.tools.console.master.ConsoleMaster) -> None:
        self.master = master
