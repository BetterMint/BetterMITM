...
import BetterMITM.tools.console.master
...
from BetterMITM.dns import DNSMessage
from BetterMITM.tools.console import common
from BetterMITM.tools.console import flowdetailview
from BetterMITM.tools.console import layoutwidget
from BetterMITM.tools.console import searchable
from BetterMITM.tools.console import tabs
...
class FlowViewHeader(urwid.WidgetWrap):
    def __init__(
        self,
        master: "BetterMITM.tools.console.master.ConsoleMaster",
    ) -> None:
        self.master = master
        self.focus_changed()
