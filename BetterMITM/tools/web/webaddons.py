...
from BetterMITM.tools.web.web_columns import AVAILABLE_WEB_COLUMNS

if TYPE_CHECKING:
    from BetterMITM.tools.web.master import WebMaster
        ...
        if hasattr(ctx.options, "web_open_browser") and ctx.options.web_open_browser:
            ...
            if not success and not ctx.options.web_password:
                logger.info(
                    ...
                    f"(https://docs.BetterMITM.org/stable/concepts-options/#web_password).",
                )
