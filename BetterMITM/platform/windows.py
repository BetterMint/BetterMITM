...
from BetterMITM.net.local_ip import get_local_ip
from BetterMITM.net.local_ip import get_local_ip6
...
class TransparentProxy:
    ...
    which mitmproxy sees, but this would remove the correct client info from BetterMITM.
    """
